...
import styles from "@/layouts/AsideNavLayout/components/Aside/index.module.scss";
import {config} from "@/layouts/AsideNavLayout/menuConfig";
const asideMenuConfig=config.menuConfig
